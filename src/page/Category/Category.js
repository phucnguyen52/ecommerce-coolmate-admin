   ...
   const onFinish = async (values) => {
      ...
      try {
         ...
         if (res.succes) {
            ...
            console.log(true)
            onReset()
            setCategorySub(modalAddCategorySub)
         }
         ...
         <div>
            ...
            {category &&
               <div className='grid gap-4 grid-cols-5'>
                  ...
                  <Modal
                     title={<div className="text-2xl font-semibold mb-8">THÊM LOẠI SẢN PHẨM</div>}
                  ...
                  >
                     ...
                     >
                        <Form.Item
                           ...
                           name="Name"
                           rules={[{ required: true, message: 'Please input your Field 1!' }]}
                        >
                           <Input />
                        </Form.Item>
                        <Form.Item className='mb-0'>
                           ...
                           <Button onClick={() => handleCancel(setModalAddCategory)}>Huỷ</Button>
                        </Form.Item>
                     </Form>
                  </Modal>
               </div>
