...
const ProductReviews = (props) => {
   ...
   const point = data ? data.count !== 0 ? (data.totalStartPoint / data.count).toFixed(2) : 0 : "";
            ...
            <div>
               <div className="flex px-4 gap-10">
                  <div className="basis-1/4 p-8 bg-[#f1f1f1] rounded-3xl text-center h-fit">
                     ...
                     {data.count &&
                        <>
                           <div className="font-extrabold text-5xl my-4">{data.point}</div>
                              ...
                              <div key={index} className="border-b py-4 pr-4 pl-2 text-sm">
                                 <div className="flex gap-3 mb-4">
                                    <div className="w-10 h-10 rounded-full">
                                       <img className="w-full h-full rounded-full object-cover " src={item.Picture} alt="" />
                                    </div>
